...
const divingPhotos = [
  ...
  { src: manta, alt: '蝠鲼', name: '蝠鲼', description: '优雅的巨型鳐鱼，以滤食方式进食' },
];
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-8">我收集的海洋图鉴</h1>
        <p className="text-xl text-gray-700 mb-6">已收集 {divingPhotos.length}/{totalPhotos} 张</p>
