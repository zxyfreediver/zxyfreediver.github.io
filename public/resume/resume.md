...
### 技术栈
- **前端核心**：JavaScript/TypeScript、React、Vue、Next.js、HTML5/CSS3、ReactNative
- **性能优化**：SSR、代码分割、懒加载
...
### 中国电信卫星公司研发效能平台
**技术栈**：React、Vite、Antd、ReactFlow、Echarts、TailwindCSS
**过程**：
- 沟通需求，协调公司各个部门，完成研发效能平台的设计与开发，推进纸质流程的数字化转型，基于 React + vite + tailwindcss 搭建项目
- 通过 ReactFlow、Antd、Echarts 组件完成研发流程的图形化展示、数据的可视化
